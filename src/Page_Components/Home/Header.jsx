        ...
        <div className="bg-cover bg-center bg-[url('https://i.pinimg.com/originals/5e/6b/1c/5e6b1c6a633aeeaa013312b69c89ab11.jpg')]">
          <div className="flex flex-col items-center justify-center min-h-screen text-center bg-[rgba(21,21,21,0.7)] p-10">
            <div className="max-w-5xl mx-auto mb-20 mt-20">
              ...
              <p className="text-white text-2xl font-bold leading-tight mt-3">
                EVIDENCE BASED HOMOEOPATHY
              </p>

              <img
                src="/logo.png"
                alt="DP Memorial Homoeopathy Clinic Logo"
                className="w-24 h-24 object-contain mx-auto mt-5 mb-6"
              />
              ...
              <Link to="/Appointment" className="inline-block">
                <button className="bg-[#f49892] hover:bg-[#f49832] text-white font-bold py-4 px-8 rounded-lg text-lg">
                  Book An Appointment
                </button>
              </Link>
            </div>
